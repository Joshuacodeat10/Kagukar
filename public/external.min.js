! function (e, t) {
    ...
    return function (e) {
        ...
        const v = s(window.location).jitsi_meet_external_api_id,
            y = {};
        let _;
        "number" == typeof v && (y.scope = "jitsi_meet_external_api_" + v), (window.JitsiMeetJS || (window.JitsiMeetJS = {}), window.JitsiMeetJS.app || (window.JitsiMeetJS.app = {}), window.JitsiMeetJS.app).setExternalTransportBackend = e => _.setBackend(e);
        var b = n(4),
            w = n(0);
                ...
                this._transport.on("event", e => {
                    ...
                    switch (t) {
                        case "video-conference-joined":
                            void 0 !== this._tmpE2EEKey && (this.executeCommand(j.e2eeKey, this._tmpE2EEKey), this._tmpE2EEKey = void 0), this._myUserID = r, this._participants[r] = {
